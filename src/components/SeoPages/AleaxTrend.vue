            ...
            getAlexa() {
                return this.$http
                    ...
                    .then(res => {
                        ...
                        this.alexa.o_d.o = this.getColor(res.data.alexaUsageStatistic.alexa_1days.change)
                        ...
                        this.alexa.s_d.o = this.getColor(res.data.alexaUsageStatistic.alexa_7days.change)
                        ...
                        this.alexa.o_m.o = this.getColor(res.data.alexaUsageStatistic.alexa_1months.change)
                        ...
                        this.alexa.t_m.o = this.getColor(res.data.alexaUsageStatistic.alexa_3months.change)
