...
@-webkit-keyframes sec_poofing1 {
  ...
  100% {
    -webkit-transform: rotateZ(268deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
...
@-webkit-keyframes sec_poofing2 {
  ...
  100% {
    -webkit-transform: rotateZ(135deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
...
@-webkit-keyframes sec_poofing3 {
  ...
  100% {
    -webkit-transform: rotateZ(442deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
...
@-webkit-keyframes sec_poofing4 {
  ...
  100% {
    -webkit-transform: rotateZ(525deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
...
@-webkit-keyframes sec_poofing5 {
  ...
  100% {
    -webkit-transform: rotateZ(419deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
...
@-webkit-keyframes sec_poofing6 {
  ...
  100% {
    -webkit-transform: rotateZ(246deg) rotateY(360deg) translateY(-700px)
      scale(0.01);
