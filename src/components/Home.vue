<template>
  ...
  <div>
        ...
        <div class="clearfix websiteValue_banner_ul1">
          ...
          <ul class="websiteValue_banner_ul clearfix">
            <li v-for="items in hotsearch">
              <a @click="doHotSearch(items)" href="javascript:void(0);">{{items}}</a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="main_content">
      <div class="img_box">
        <img src="../assets/17chalogo.png" alt />
      </div>
...
<style scoped>
.websiteValue_banner {
  background: url("../assets/websiteValue-banner.png") no-repeat center center;
  height: 480px;
  width: 100%;
}
