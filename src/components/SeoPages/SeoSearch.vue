            ...
            <div>
              ...
              <span class="black">{{icp_createtime}}</span>
                    ...
                    <li>
                        ...
                        <span class="msg_details">
              注册邮箱：
              <span class="black">{{email_code}}</span>
            </span>
                        <span class="msg_details">
              年龄：
              <span class="black">{{whios_created}}</span>（{{whios_created2}}）
            </span>
                    </li>
                    <li>
            ...
            <div class="echarts_container">
                ...
                <div class="echarts_main">
                    <table width="1200px" class="bn_right">
                        ...
                        <tr>
                            <td v-for="items in word_localtion_local">
                                {{items}}
                            </td>
                        </tr>
                    </table>
        ...
        methods: {
                ...
                this.$http
                    ...
                    .then(res => {
                        if (res.data.min_ip && res.data.max_ip) {
                            this.baidulailu = this.toThousands(res.data.min_ip) + ' ~ ' + this.toThousands(res.data.max_ip)
                        } else {
                            this.baidulailu = '-'
                        }
                        this.weightcontent.aizhan.weight = res.data.br ? res.data.br : '-'
                        this.weightcontent.yidong.weight = res.data.m_br ? res.data.m_br : '-'
                ...
                this.$http
                    ...
                    .then(res => {
                        ...
                        if (res.data.icp_time) {
                            ...
                            this.icp_createtime = date.getFullYear() + '-' + (date.getUTCMonth() + 1) + '-' + date.getUTCDate()
                        } else {
                            this.icp_createtime = '-'
                        }
            ...
            getWhois() {
                this.$http
                    ...
                    .then(res => {
                        ...
                        this.whios_created = res.data.created ? this.timeDiff(res.data.created) : '-'
                        this.whios_created2 = res.data.created ? "创建于" + res.data.created.replace("-", "年").replace("-", "月") + "日" : '-'
                    })
                    .catch(res => {
                        console.log(res.msg)
                    });
            ...
            getSpeed() {
                this.$http
                    ...
                    .then(res => {
                        this.speed = res.data.telecom ? "电信:" + res.data.telecom : '测速失败'
                    })
                    .catch(res => {
                        console.log(res.msg)
                    });
            ...
            getShoulu1() {
                this.$http
                    ...
                    .then(res => {
                        ...
                        this.shoulu_360 = res.data[360] ? res.data[360] : (res.data.s_360 ? res.data.s_360 : '-')
            ...
            getShoulu2() {
                this.$http
                    ...
                    .then(res => {
                        ...
                        this.fanlian_360 = res.data['360_r'] ? res.data['360_r'] : (res.data.f_360 ? res.data.f_360 : '-')
            ...
            getShoulu3() {
                this.$http
                    ...
                    .then(res => {
                        ...
                        this.shoulu_30day = res.data.baidu_30days ? res.data.baidu_30days : '-'
                    })
                    .catch(res => {
                        console.log(res.msg)
                    });
            ...
            getWebpage() {
                this.$http
                    ...
                    .then(res => {
                        this.server_type = res.data.header.Server ? res.data.header.Server : '-'
                        this.page_type = res.data.header.ContentType ? res.data.header.ContentType : '-'
                        this.xieyi_type = res.data.header.Protocol ? res.data.header.Protocol : '-'
                    })
                    .catch(res => {
                        console.log(res.msg)
                    });
            ...
            timeDiff(t) {
                ...
                return (i = new Date(i)).getFullYear() - 1970 + "年" + i.getMonth() + "月" + (i.getDate() - 1) + "日"
            },
            transfPage(v) {
                var i = v % 10
                var j = (v - i) / 10 + 1
